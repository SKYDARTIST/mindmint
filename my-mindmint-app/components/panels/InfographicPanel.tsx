...
export default function InfographicPanel({ input, setInput }: InfographicPanelProps) {
  return (
      ...
      <div className="card">
        <div className="card-header">
          <div className="card-title">
            ...
            <span className="capitalize">Infographic</span>
          </div>
        </div>
        ...
        <div className="flex-1 p-4 md:p-6 overflow-y-auto">
          <textarea
            ...
            placeholder="Infographic generation coming soon..."
            spellCheck={false}
            disabled
          />
        </div>
