...
export default function FlashcardsPanel({ input, setInput }: FlashcardsPanelProps) {
  return (
      ...
      <div className="card">
        <div className="card-header">
          <div className="card-title">
            ...
            <span className="capitalize">Flashcards</span>
          </div>
        </div>
        ...
        <div className="flex-1 p-4 md:p-6 overflow-y-auto">
          <textarea
            ...
            placeholder="Flashcard generation coming soon..."
            spellCheck={false}
            disabled
          />
        </div>
        ...
        <div className="action-bar animate-in-fade">
          ...
          <p className="text-center text-[11px] text-gray-400 dark:text-gray-500 mt-3 font-medium tracking-wide opacity-80">
            Flashcard generation coming soon.
          </p>
        </div>
      </div>
    </section>
